...
<?php
    //Если читаете это, то, надеюсь, что вам не нужен был хороший фронт) Извините, если все-таки нужен был, не кикайте на втором этапе из-за него, я исправлюсь👉👈 
    //Ну и на всякий пусть останется тут адрес сайта http://e91545x6.beget.tech/site_iits/tt.php
